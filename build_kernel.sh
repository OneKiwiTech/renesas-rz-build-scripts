...
if [ "$MACHINE" == "onekiwi-rzv2h-dev" ] ; then BSP_TYPE="RZV2H" ; DTB="onekiwi-rzv2h-dev.dtb" ; fi
if [ "$MACHINE" == "onekiwi-rzv2h-8gb" ] ; then BSP_TYPE="RZV2H" ; DTB="onekiwi-rzv2h-8gb.dtb" ; fi
if [ "$MACHINE" == "onekiwi-rzv2h-16gb" ] ; then BSP_TYPE="RZV2H" ; DTB="onekiwi-rzv2h-16gb.dtb" ; fi
if [ "$MACHINE" == "onekiwi-rzv2l" ]    ; then BSP_TYPE="RZV2L" ; DTB="onekiwi-rzv2l.dtb" ; fi
